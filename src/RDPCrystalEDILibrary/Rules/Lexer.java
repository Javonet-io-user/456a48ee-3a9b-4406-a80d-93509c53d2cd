...
import jio.System.Collections.Generic.*;public class Lexer implements IDisposable {protected NObject javonetHandle; /**
	 ...
	 * Method
	 */
            public java.lang.Boolean Next (){ try { return javonetHandle.invoke("Next");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return false;} }	static {
		try {
